...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
  if ([segue.identifier isEqualToString:@"download"]) {
    ...
    DownloadViewController *downloadViewController = (DownloadViewController*)segue.destinationViewController;
    downloadViewController.path = selectedThumbnail.path;
    downloadViewController.session = self.session;
  }
}
